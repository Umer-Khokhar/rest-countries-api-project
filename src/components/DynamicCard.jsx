    ...
    return (
        <div className="flex flex-wrap w-full md:justify-between gap-8 items-center my-10 justify-center">
            {cardsToDisplay.map((card ,index) => (
                <div onClick={() => handleCardClick(card.alpha3Code.toLowerCase())} className="md:w-[18.5rem] shadow-md rounded-md bg-white cursor-pointer transition-all transform hover:-translate-y-4 w-5/6 dark:bg-navBg dark:text-gray-50" key={card.numericCode + index}>
                    ...
                    <div className={'p-6'}>
                        ...
                        <div className="pt-6 pb-4 flex flex-col gap-2">
                            <p  className={'dark:text-gray-300'}>
                                <b className="font-semibold dark:text-gray-200">Population:</b> {card.population}
                            </p>
                            <p className={'dark:text-gray-300'}>
